      ...
      <div className="navbar-expand-lg ">
        <div className=" navbar-collapse">
          <ul className="navbar-nav">
            <li className="breadcrumb-item active" aria-current="page"><a href="/"><small><h6 className="d-inline">Admin</h6></small></a></li>
            <li className="breadcrumb-item active mt-1" aria-current="page"><small><h6 className="d-inline">Tenants</h6></small></li>
          </ul>
          <ul className="navbar-nav ml-auto ">
            <li className=" navbar-item nav-user">
              {/* <a href="add-task.html" class="btn btn-primary py-2 px-3 label-text">Add Task</a>*/}
            </li>
          </ul>
        </div>
      </div>
...
*/}
  ...
  <div className="row no-gutter">
    <div className=" mb-2 col-lg-12 col-xl-12 col-md-12 px-0">
            ...
            <div className="tab-pane fade show active" id="activities" role="tabpanel" aria-labelledby="activities-tab">
              ...
              <div className style={{overflowX: 'scroll'}}>
                <table className="table table-bordered table-hover table-responsive w-100 d-table mb-0 " style={{overflowX: 'scroll'}}>
                  ...
                  <tbody>
                    <tr className>
                      <td data-label="Status">Name1</td>
                      <td data-label="Status">Inprogress</td>
                      <td data-label="Status"><a href>www.tenant@tenant.com</a></td>
                      <td data-label="Subject">20/12/2020</td>
                      <td data-label="Subject">20/1/21</td>
