      ...
      <div className="navbar-expand-lg ">
        <div className=" navbar-collapse">
          <ul className="navbar-nav">
            ...
            <li className="breadcrumb-item active mt-1" aria-current="page"><small><h6 className="d-inline">Roles</h6></small></li>
          </ul>
          <ul className="navbar-nav ml-auto ">
            <li className=" navbar-item nav-user">
              {/* <a href="add_task" class="btn btn-primary py-2 px-3 label-text">Add Task</a>*/}
            </li>
          </ul>
        </div>
      </div>
                ...
                <table className="table table-bordered table-hover table-responsive w-100 d-table mb-0 " style={{overflowX: 'scroll'}}>
                  ...
                  <tbody>
                    <tr className>
                      ...
                      <td data-label="Schedule Start date">
                        <input type="text" className="form-control" />
                      </td>
                    </tr>
                    <tr className>
                      <td data-label="Subject">2</td>
                      <td data-label="Schedule Start date">
                        <input type="text" className="form-control" />
                      </td>
                    </tr>
                    <tr className>
                      <td data-label="Subject">3</td>
                      <td data-label="Schedule Start date">
                        <input type="text" className="form-control" />
                      </td>
                    </tr>
                    <tr className>
                      <td data-label="Subject">4</td>
                      <td data-label="Schedule Start date">
                        <input type="text" className="form-control" />
                      </td>
                    </tr>
                    <tr className>
                      <td data-label="Subject">5</td>
                      <td data-label="Schedule Start date">
                        <input type="text" className="form-control" />
                      </td>
                    </tr>
