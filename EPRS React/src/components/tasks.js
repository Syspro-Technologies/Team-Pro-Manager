      ...
      <div className="navbar-expand-lg ">
        <div className="navbar-collapse">
          <ul className="navbar-nav px-2">
            ...
            <li className="breadcrumb-item active mt-1" aria-current="page"><small><h6 className="d-inline">Tasks</h6></small></li>
          </ul>
          ...
          <ul className="navbar-nav ml-auto text-right">
            <li className=" navbar-item nav-user">
              <a href="issues" className="btn btn-primary py-2 px-3 label-text">View All Issues</a>
            </li>
            <li className="px-2 navbar-item nav-user">
          ...
          <div className=" view-button inner-data pb-0 ">
            <ul className="navbar-nav border-box ">
              ...
              <li>
                <a href="#" className="text-dark" data-toggle="tooltip" data-placement="top" title data-original-title="Calender View">
                ...
                <table className="table table-bordered table-hover table-responsive w-100 d-table mb-0 " style={{overflowX: 'scroll'}}>
                  ...
                  <tbody>
                    <tr className>
                      ...
                      <td data-label="Action">
                        <div className="align-right tile-icon">
                          <a href="add-task.html" className><small><i className="material-icons text-dark">edit</i></small></a>
                          <a href="#"><small><i className="material-icons text-dark">delete</i></small></a>
                          <a href="#"><small><i className="material-icons text-dark" data-toggle="tooltip" data-placement="top" title data-original-title="Add Bug">pest_control</i></small></a>
                        </div>
                      </td>
                    </tr>
                    <tr className>
                    ...
                    <tr className>
                      ...
                      <td data-label="Status">Inprogress</td>
                      <td data-label="Action">
                        <div className="align-right" style={{fontSize: 16}}>
                          <a href="add-task.html" className><small><i className="material-icons text-dark">edit</i></small></a>
                          <a href="#"><small><i className="material-icons text-dark">delete</i></small></a>
                          <a href="#"><small><i className="material-icons text-dark" data-toggle="tooltip" data-placement="top" title data-original-title="Add Bug">pest_control</i></small></a>
                        </div>
