...
function add_task() {
  sessionStorage.setItem("menuactive","tasks");
        ...
        <div className="navbar-expand-lg ">
          <div className=" navbar-collapse">
            <ul className="navbar-nav">
              ...
              <li className="breadcrumb-item active mt-1" aria-current="page"><small><h6 className="d-inline">Create Task</h6></small></li>
            </ul>
            <ul className="navbar-nav ml-auto ">
              <li className=" navbar-item nav-user mx-2">
                <a href="tasks" className="btn btn-outline-primary py-2 px-3 label-text">Cancle</a>
              </li>
              <li className=" navbar-item nav-user mx-2">
                <a href="tasks" className="btn btn-primary py-2 px-3 label-text">Save</a>
              </li>
              <li className=" navbar-item nav-user">
                <a href="tasks" className="btn btn-primary py-2 px-3 label-text">Save &amp; New</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="p-3">
        <div className="row">
          <div className="form-group col-lg-6 col-md-12">
            <label htmlFor="exampleFormControlSelect1">Task #</label>
            <input type="text" disabled className="form-control" placeholder defaultValue={1020} />
          </div>
          <div className="form-group col-lg-6 col-md-12">
        ...
        <div className="row">
          ...
          <div className="form-group col-lg-3 col-md-12">
            ...
            <input type="text" className="form-control" placeholder="Actual Start Date" />
          </div>
          <div className="form-group col-lg-3 col-md-12">
            <label className="label-text">Actual End Date</label>
            <input type="text" className="form-control" placeholder="Actual End Date" />
          </div>
          <div className="form-group col-lg-6 col-md-12">
          ...
          <div className="form-group col-lg-6 col-md-12">
            <label htmlFor="exampleFormControlSelect1">Task Type</label>
            <select className="form-control" id="exampleFormControlSelect1">
          ...
          <div className="form-group col-lg-6 col-md-12">
            <label htmlFor="exampleFormControlSelect1">Assigne To</label>
            <select className="form-control" id="exampleFormControlSelect1">
          ...
          <div className="form-group col-lg-6 col-md-12">
            <label htmlFor="exampleFormControlSelect1">Team Lead</label>
            <select className="form-control" id="exampleFormControlSelect1">
              <option> User 1</option>
              <option>User 2</option>
              <option>User 3</option>
